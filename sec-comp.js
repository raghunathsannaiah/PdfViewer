 ...
 */
class SecComp extends  GestureEventListeners(PolymerElement) {
 static get template() {
    return html`
    <style>
      :host {
...
`;
  ...
  ready(){
  console.log('ttt sss'+this.tagName);
  ...
  constructor() {
    ...
    //pdfjsLib.GlobalWorkerOptions.workerSrc = '//mozilla.github.io/pdf.js/build/pdf.worker.js';
            //this.PDFJS = pdfjsDistWebPdfViewer;

           this.PDFJS.GlobalWorkerOptions.workerSrc = this.PDFJS_workerSrc;
           this._nextBtnListener = this.next.bind(this);
            this._previousBtnListener = this.previous.bind(this);
            this._fitWidthBtnListener = this.fitWidth.bind(this);
            this._fitBtnListener = this.fit.bind(this);
            this._zoominBtnListener = this.zoomin.bind(this);
            this._zoomoutBtnListener = this.zoomout.bind(this);
  ...
  connectedCallback() {
    ...
    document.getElementById('next').addEventListener('tap', this._nextBtnListener);
    document.getElementById('previous').addEventListener('tap', this._previousBtnListener);
    document.getElementById('fitWidth').addEventListener('tap', this._fitWidthBtnListener);
    document.getElementById('fit').addEventListener('tap', this._fitBtnListener);
    document.getElementById('zoomin').addEventListener('tap', this._zoominBtnListener);
    document.getElementById('zoomout').addEventListener('tap', this._zoomoutBtnListener);
  }

  disconnectedCallback() {
        super.disconnectedCallback();
        this.removeEventListener('iron-resize', this._recenter)
        document.getElementById('next').removeEventListener('tap', this._nextBtnListener);
        document.getElementById('previous').removeEventListener('tap', this._previousBtnListener);
        document.getElementById('fitWidth').removeEventListener('tap', this._fitWidthBtnListener);
        document.getElementById('fit').removeEventListener('tap', this._fitBtnListener);
        document.getElementById('zoomin').removeEventListener('tap', this._zoominBtnListener);
        document.getElementById('zoomout').removeEventListener('tap', this._zoomoutBtnListener);
    }
...
window.customElements.define('pdf-viewer', SecComp);
